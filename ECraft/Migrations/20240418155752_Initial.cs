        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LocationStates_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cities_LocationStates_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraLocationDetails = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Crafters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Crafters_AppUser_Id",
                        column: x => x.Id,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Crafters_Crafts_CraftId",
                        column: x => x.CraftId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IntroImg = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PrivateToOwner = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CraftProjects", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CraftProjects_Crafters_CrafterId",
                        column: x => x.CrafterId,
                        principalTable: "Crafters",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CraftProjects_Crafts_CraftId",
                        column: x => x.CraftId,
                        principalTable: "Crafts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Crafters_CraftId",
                table: "Crafters",
                column: "CraftId");

            migrationBuilder.CreateIndex(
                name: "IX_CraftProjects_CrafterId",
                table: "CraftProjects",
                column: "CrafterId");

            migrationBuilder.CreateIndex(
                name: "IX_CraftProjects_CraftId",
                table: "CraftProjects",
                column: "CraftId");
